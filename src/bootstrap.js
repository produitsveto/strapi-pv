...
const CONTENT_TYPE_CONFIG = {
  ...
  'api::marketing-campaign.marketing-campaign': {
    ...
    labels: {
      ...
      brand_handles: 'Marques / laboratoires',
    ...
    descriptions: {
      ...
      brand_handles: 'Bannière marque et Produits en vedette d’une marque : pages marque où la campagne s’affiche — choisir la marque et, si besoin, son laboratoire (ex. DRONTAL et VETOQUINOL). Vente croisée : fiches des produits de ces marques. Top laboratoires : marques mises à la une dans le panneau « Marques » du méga-menu, dans l’ordre choisi.',
